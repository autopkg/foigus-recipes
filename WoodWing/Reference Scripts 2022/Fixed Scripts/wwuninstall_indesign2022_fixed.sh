...
##path_only="/Applications/Adobe InCopy 2022"
...
##Again the assumption this would only ever run from the supplied uninstaller strikes
##rm -Rf "${uninstaller_path}"
rm -Rf "/Applications/Adobe InDesign 2022/Uninstall WoodWing Studio for InDesign and InCopy 2022.app"
